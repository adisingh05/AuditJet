          ...
          {frameworks.map((framework) => {
            ...
            return (
              <div
                ...
                className={`bg-gray-900 rounded-2xl p-6 border cursor-pointer transition-all duration-150 hover:scale-[1.01] ${isIndia
              ...
              >
                <div className="flex items-center justify-between mb-4">
                  <span
                    className={`px-3 py-1 rounded-full text-xs font-medium ${isIndia
